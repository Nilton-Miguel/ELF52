...
PortN_Invertepino0
	PUSH 	{LR}
	LDR		R1, =GPIO_PORTN_AHB_DATA_BITS_R		;Carrega o valor do offset do data register
	ADD 	R1, #0x04							;Soma ao offset o endereço do bit 1 para ser 
												;uma leitura e escrita amigável
...
PortN_Invertepino1
	PUSH 	{LR}
	LDR		R1, =GPIO_PORTN_AHB_DATA_BITS_R		;Carrega o valor do offset do data register
	ADD 	R1, #0x08							;Soma ao offset o endereço do bit 1 para ser 
												;uma leitura e escrita amigável
	LDR 	R0, [R1]							;Carrega o valor atual para inverter
...
PortJ_Input
	...
	ADD 	R1, #0x0C							;Soma ao offset o endereço dos bit 0 e 1 para 
...
GPIOPortJ_Handler
    ...
    EOR		R2, R2, #2_1					;escrita amigável               
    STR		R2, [R1]						;atualiza o registrador
	
	LDR		R1, =TIMER0_CTL_R				;Carrega o endereço do CTL para poder desabilitar
    LDR		R2, [R1]                    	;lê o conteúdo do registrador e coloca em R2 para fazer o OR abaixo
    EOR		R2, R2, #2_1					;escrita amigável               
    STR		R2, [R1]						;atualiza o registrador
