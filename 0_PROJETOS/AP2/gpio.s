...
; 2. Limpar o AMSEL para desabilitar a analógica
	...
	LDR     R0, =GPIO_PORTN_AMSEL_R     ;Carrega o R0 com o endereço do AMSEL para a porta J
    STR     R1, [R0]
...
; 3. Limpar PCTL para selecionar o GPIO
    ...
    STR     R1, [R0]
	LDR     R0, =GPIO_PORTN_PCTL_R		;Carrega o R0 com o endereço do PCTL para a porta J
...
; 5. Limpar os bits AFSEL para 0 para selecionar GPIO, Sem função alternativa
    ...
    STR     R1, [R0]                        ;Escreve na porta
	LDR     R0, =GPIO_PORTN_AFSEL_R     	;Carrega o endereço do AFSEL da porta J
    STR     R1, [R0]
