...
BUBBLE_SORT
; Realizar bubble sort em uma lista -----------------------------------------
; Assume que r0 contem o endereço do primeiro elemento na RAM
; e r1 contem a quantidade de elementos da lista
;----------------------------------------------------------------------------   
...
ROM_LISTA_ALEATORIOS
		...
		; na ROM após a gravação do código de 
		; máquina vem a gravação desses números
		; CARREGA_ROM é o endereço do primeiro 
		; endereço de ROM que guarda os 
		
		DCB 193, 63, 176, 127, 43, 13, 211, 3, 203, 5, 21, 7
		DCB 206, 245, 157, 237, 241, 105, 252, 19

; ROM_TAMPA é o primeiro endereço que não faz parte da lista
ROM_TAMPA
		
		; valor aleatorio só para a label existir
		DCB 69
